...
from ultralytics.nn.modules import (C1, C2, C3, C3TR, SPP, SPPF, Bottleneck, BottleneckCSP, C2f, C3Ghost, C3x, Classify,
                                    ...
                                    GhostBottleneck, GhostConv, Segment, C2f_DCN, BoT3, ConvMod)
...
# from ultralytics.nn.new.DOConv import DOConv2d
from ultralytics.nn.new.DCNV3 import DCNV3_YoLo
from ultralytics.nn.new.CrissCross import CrissCrossAttention
...
def parse_model(d, ch, verbose=True):  # model_dict, input_channels(3)
    ...
    ########################################################################################
       #注意力机制
        elif m in {MHSA}:              # if配置文件中是MHSA模块
            args = [ch[f], *args]      # 那参数这样定义
        elif m in {ShuffleAttention}:
            args = [ch[f], *args]
        elif m in {CBAMBlock, BoT3, ConvMod, CrissCrossAttention}:
            args = [ch[f], *args]
    ########################################################################################
        elif m is Concat:
